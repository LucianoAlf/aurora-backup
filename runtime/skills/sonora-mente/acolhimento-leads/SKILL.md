...
description: Use quando alguém desconhecido ou lead escrever pela primeira vez, perguntar como funciona, preço ou horário, ou quando uma família nova sumir (follow-up). Acolhe, registra o lead e passa ao Serjão.
---
...
5. **Apresente** a musicoterapia e a Consulta de Acolhimento (primeiro passo, com a coordenação clínica). **Preço e horário são com o Serjão:** diga que ele vai falar com a família e quando (expediente: seg–sex 10h–19h, sáb 8h–12h).
...
**Nunca:** marcar agendado ou ativo (é da equipe), prometer vaga, horário ou valor, ou perguntar diagnóstico. Se a família contar algo clínico por conta própria, acolha, não comente e diga que a Bianca conversa sobre isso na Consulta de Acolhimento.
