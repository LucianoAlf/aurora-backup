...
5. **Apresente** a musicoterapia e a Consulta de Acolhimento (primeiro passo, com a coordenação clínica). **Preço e horário são com a equipe de atendimento:** diga que a equipe vai falar com a família e quando (expediente: seg–sex 10h–19h, sáb 8h–12h).
