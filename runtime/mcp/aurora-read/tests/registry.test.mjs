...
test('allowlist tem exatamente as ferramentas aprovadas', () => {
  assert.deepEqual(Object.keys(TOOL_DEFINITIONS).sort(), ['aurora_agenda_do_dia', 'aurora_conferir_crianca', 'aurora_pacote_status', 'aurora_pacotes_atencao', 'aurora_quem_e', 'aurora_sessoes_paciente', 'aurora_simular_recesso']);
});
